...
**If Else** (similar to `dplyr::nest()` or `dplyr::group_nest()` and `tidyr::unnest()`):
...
The nesting and unnesting functions were shown in a [previous preprint](https://psyarxiv.com/u8ekc/). Herein, I show more simple applications. The following data table will be used for the examples.
