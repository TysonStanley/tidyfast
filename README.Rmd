...
- [mtfairbanks](https://github.com/markfairbanks) for PR #6 providing initial the pivoting functions. Note the [`gdt`](https://github.com/markfairbanks/tidytable) package that compliments some of `tidyfast`s functionality.
